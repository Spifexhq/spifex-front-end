...
const BankSettings: React.FC = () => {
  ...
  const { organization: authOrg, isOwner, permissions } = useAuthContext();
  ...
  useEffect(() => {
    if (!canViewBanks) return;
    refresh();
  }, [canViewBanks, refresh]);
  ...
  /* ------------------------------ Loading --------------------------------- */
  const shouldBlockOnInitial = isInitialLoading && canViewBanks;
    ...
    <>
      ...
      <main className="min-h-[calc(100vh-64px)] bg-transparent text-gray-900 px-6 py-8">
        <div className="max-w-5xl mx-auto">
          ...
          <PermissionMiddleware codeName={"view_bank"} behavior="lock">
      ...
      {/* BRANCH POPOVER */}
      <Popover open={openFilter === "branch"} anchorRef={branchAnchorRef} onClose={() => setOpenFilter(null)}>
        <div className="p-4">
      ...
      {/* IBAN POPOVER */}
      <Popover open={openFilter === "iban"} anchorRef={ibanAnchorRef} onClose={() => setOpenFilter(null)}>
        <div className="p-4">
