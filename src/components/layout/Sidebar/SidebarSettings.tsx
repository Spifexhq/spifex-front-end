...
const SidebarSettings: React.FC<SidebarSettingsProps> = ({
    ...
    () => [
      {
        ...
        id: "me",
        items: [
          { id: "personal", icon: "personal" as IconKey, label: t("items.personal") },
          { id: "notifications", icon: "bell" as IconKey, label: t("items.notifications") },
          { id: "security", icon: "shield" as IconKey, label: t("items.security") },
        ],
      },
      {
      ...
      },
      {
        ...
        id: "banking",
        items: [
          { id: "banks", icon: "bank" as IconKey, label: t("items.banks") },
          { id: "bank-statements", icon: "card" as IconKey, label: t("items.bank-statements") },
          // { id: "expenses", icon: "receipt" as IconKey, label: t("items.expenses") },
        ],
      },
      {
        ...
        id: "mgmt",
        items: [
          { id: "projects", icon: "projects" as IconKey, label: t("items.projects") },
          { id: "inventory", icon: "inventory" as IconKey, label: t("items.inventory") },
          { id: "entities", icon: "entities" as IconKey, label: t("items.entities") },
        ],
      },
      {
        ...
        id: "acct",
        items: [
          { id: "ledger-accounts", icon: "ledger" as IconKey, label: t("items.ledger-accounts") },
          { id: "departments", icon: "departments" as IconKey, label: t("items.departments") },
        ],
      },
    ],
    [t]
  ...
  const activeIdx = Math.max(0, flatItems.findIndex((i) => i.id === activeItem));
