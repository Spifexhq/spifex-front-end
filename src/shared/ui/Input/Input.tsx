...
function isPercentage(props: InputProps): props is PercentageInputProps {
  return props.kind === "percentage";
}
...
const Input = forwardRef<HTMLInputElement, InputProps>((props, ref) => {
  ...
  if (isPercentage(props)) return <PercentageField {...props} ref={ref} />;
